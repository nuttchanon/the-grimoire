---
description: Run the verify script and dispatch the Warden for independent sign-off.
---
...
3. Spawn the **warden** familiar (Task/Agent tool) on **fresh context**, passing ONLY:
...
4. Relay the Warden''s structured verdict. If `fail`, the change is **not done** — address the
